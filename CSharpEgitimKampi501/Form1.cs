...
namespace CSharpEgitimKampi501
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection connection = new SqlConnection("Server=ELIF\\SQLEXPRESS;initial Catalog=EgitimKampi501Db;integrated security=true");
        private async void btnListe_Click(object sender, EventArgs e)
        {
        ...
        private async void Form1_Load(object sender, EventArgs e)
        {
            ...
            llblDistinctCategoryCount.Text = distinctProductCount.ToString();
        }
    }
}
